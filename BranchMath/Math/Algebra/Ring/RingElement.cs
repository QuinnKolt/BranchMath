...
namespace BranchMath.Math.Algebra.Ring {
    ...
    public class RingElement<I> : AlgebraicElement<I>, FieldLikeObject<RingElement<I>>, Powerable<RingElement<I>, Integer> {
        /// <summary>
        ...
        public RingElement<I> getZero() {
            return ((Ring<I>) structure).getZero();
        }
        ...
        public RingElement<I> getOne() {
            return ((Ring<I>) structure).getOne();
        }
        ...
        public virtual RingElement<I> pow(Natural p) {
            return this ^ p;
        }
    }
}